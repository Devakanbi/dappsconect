...
<body>
          ...
          <div class="cf-column">
            ...
            <p>
              <form action="/cdn-cgi/phish-bypass" method="GET">
                <input type="hidden" name="atok" value="FrQQ69ytfarI0ghLKoQ47oFG_AMT6wdqAlSWGU6pabY-1713728271-0.0.1.1-/get/tM8s7Uiw/72cd5d70_3cfb8209efeda.js">
  ...
  <p class="text-13">
    <span class="cf-footer-item sm:block sm:mb-1">Cloudflare Ray ID: <strong class="font-semibold">877fd4c1bb57412d</strong></span>
    <span class="cf-footer-separator sm:hidden">&bull;</span>
    <span id="cf-footer-item-ip" class="cf-footer-item hidden sm:block sm:mb-1">
      Your IP:
      <button type="button" id="cf-footer-ip-reveal" class="cf-footer-ip-reveal-btn">Click to reveal</button>
      <span class="hidden" id="cf-footer-ip">105.113.94.76</span>
      <span class="cf-footer-separator sm:hidden">&bull;</span>
    </span>
